...
function templateLicenseGate(minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      ...
      '<img class="ql-title-logo" src="' + chrome.runtime.getURL('assets/logo-master-lovable-square.png') + '" alt=""><span class="ql-title">Empire Lovable Vip Extension</span>' +
    '</div>' +
...
function templateMainUI(greeting, statusBadge, minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      '<span class="ql-brand"><img class="ql-brand-logo" src="' + chrome.runtime.getURL('assets/logo-master-lovable-square.png') + '" alt=""><span>Empire Lovable Vip Extension</span></span>' +
    '</div>' +
    '<div class="ql-header-right">' +
  ...
  '<div id="ql-footer" class="ql-footer">' +
    ...
    '</div>' +
    '<span class="ql-badge-mz">Empire Lovable Vip Extension</span>' +
  '</div>' +
  '<div id="ql-resize-handle" class="ql-resize-handle"></div>' +
  '<!-- Notifications Panel -->' +
