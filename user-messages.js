/**
 * Empire - User-facing copy: English translations + strip internal/hosting/vendor branding.
 */
 */
function stripInternalBranding(value) {
  if (value == null) return value;
  var brand = typeof EXTENSION_NAME !== "undefined" ? String(EXTENSION_NAME) : "Empire Lovable Vip Extension";
  var s = String(value);
